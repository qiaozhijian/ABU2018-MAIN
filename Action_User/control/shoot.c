...
void prepareMotionParaInit(void)
{
  ...
  PrepareShootBall2.pitchAngle=7.8f;
  ...
  PrepareShootColorBall[1].gasAim=0.58f;
	...
	/*金球1备件的射球参数*/
  PrepareShootGoldBall[0].courseAngle=178.f;
  PrepareShootGoldBall[0].pitchAngle=3.0f;
