...
void prepareMotionParaInit(void)
{
  ...
  PrepareShootBall3.pitchAngle=-1.50f;
  ...
  PrepareShootBall3.gasAim=0.5f;
	...
	/*准备射第四个球的数据*/
	PrepareShootBall4.courseAngle=179.0f;
