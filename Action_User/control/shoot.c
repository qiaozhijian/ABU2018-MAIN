...
void prepareMotionParaInit(void)
{
  ...
  PrepareShootBall1.pitchAngle=13.f;
  ...
  PrepareGetBall3.gasAim=PrepareShootBall3.gasAim;
	...
	/*准备射第四个球的数据*/
	PrepareShootBall4.courseAngle=178.2f;
  PrepareShootBall4.pitchAngle=5.0f;
