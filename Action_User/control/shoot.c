...
void prepareMotionParaInit(void)
{
  ...
  /*准备射第一个球的数据*/
  PrepareShootBall1.courseAngle=174.6f;
  PrepareShootBall1.pitchAngle=10.6f;
  ...
  PrepareShootBall2.pitchAngle=8.6f;
  ...
  PrepareShootBall3.pitchAngle=3.4f;
  ...
  PrepareShootBall3.gasAim=0.5f;
	...
	PrepareGetBall4.upSteerAngle = -63.f;
	PrepareGetBall4.downSteerAngle = -63.f;
