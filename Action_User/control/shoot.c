...
void prepareMotionParaInit(void)
{
  ...
  /*准备射第二个球的数据*/
  PrepareShootBall2.courseAngle=174.0f;
  PrepareShootBall2.pitchAngle=6.7f;
  ...
  PrepareGetBall3Wait.gasAim=0.50f;
	/*接取第三个球的参数*/
