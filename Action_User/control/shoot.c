...
{
	/*准备射第一个球的数据*/
  PrepareShootBall1.courseAngle=168.8f;
  ...
  /*准备射第二个球的数据*/
  PrepareShootBall2.courseAngle=174.1f;
  ...
  /*准备去拿第二个球的数据*/
  PrepareGetBall2.courseAngle=81.5f;
  PrepareGetBall2.pitchAngle=0.f;
  PrepareGetBall2.upSteerAngle=101.f; 
	PrepareGetBall2.downSteerAngle=100.f;
  ...
  PrepareShootBall3.gasAim=0.545f;
	
	
  /*准备等待拿第三个球的数据*/
  PrepareGetBall3Wait.courseAngle=120.f;
  PrepareGetBall3Wait.pitchAngle=-2.3f;
  ...
  PrepareShootGoldBall[1].gasAim=0.562f;
