...
/* Exported macro ------------------------------------------------------------*/
//开辟一个四百字节大小
#define USART1_SEND_BUF_CAPACITY 400u
	 
extern uint16_t USART1SendBufferCnt;
extern uint8_t USART1SendBuf[USART1_SEND_BUF_CAPACITY];
extern uint8_t USART1DMASendBuf[USART1_SEND_BUF_CAPACITY];
/* Exported functions --------------------------------------------------------*/
